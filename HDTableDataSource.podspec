#
#  Be sure to run `pod spec lint HDTableDataSource.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "HarshitDaftary"
  # s.authors            = { "HarshitDaftary" => "daftaryharshit@yahoo.co.in" }
  # s.social_media_url   = "http://twitter.com/HarshitDaftary"
